      ...
      <div className="glass-card" style={{ marginBottom: 'var(--space-6)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
          <div>
            ...
            <p style={{ fontSize: 'var(--text-sm)', color: 'var(--text-secondary)' }}>{profile.xp} / {profile.xpToNext} XP</p>
          </div>
        ...
        <div className="progress-bar" style={{ height: 10 }}>
          <div className="progress-fill" style={{ width: `${(profile.xp / profile.xpToNext) * 100}%` }} />
        </div>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 8, fontSize: 'var(--text-xs)', color: 'var(--text-tertiary)' }}>
          <span>Level {profile.level}</span>
          <span>{profile.xpToNext - profile.xp} XP to next level</span>
